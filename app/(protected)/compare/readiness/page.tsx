...
export default async function CompareReadinessPage() {
    ...
    <div>
      ...
      <div className="border-b border-line bg-canvas px-6 py-5">
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div>
            <h1 className="text-xl font-semibold text-ink">Readiness Compare</h1>
            <p className="text-sm text-muted mt-0.5">
              Recovery · Sleep · HRV · RHR · ATL · CTL · 7-day trend comparison
            </p>
          </div>
          <div className="flex items-center gap-2">
            <Link
              href="/compare/performance"
      ...
      <div className="px-6 py-5">
        <CompareWorkbench athletes={dashboard.athletes} section="readiness" />
      </div>
    </div>
  );
}
